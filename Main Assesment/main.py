...
metadata = {
    "apiLevel": "2.15",
    "protocolName": "Optimizing Serial Dilution Protocol",
    "description": "Using JMP, we are investigating the optimum serial dilution protocol parameters.",
    "author": "Haotong, Matt, Wilson"
    }
