...
metadata = {
    "apiLevel": "2.15",
    "protocolName": "Serial Dilutions (PB exp 4)",
    "description": "Serial dilution with parameters from PB experiment 4",
    "author": "Wilson et al"
}

PARAMS = {'Aspiration_Rate': 0.25, 'Aliquot_Aspiration_Rate': 0.25, 'Dilution_Aspiration_Rate': 0.25, 'Mix_Aspiration_Rate': 0.25, 'Aspiration_Height': 1.0, 'Aliquot_Aspiration_Height': 1.0, 'Dilution_Aspiration_Height': 1.0, 'Mix_Aspiration_Height': 1.0, 'Mix_Aspiration_Height_Min': 1.0, 'Mix_Aspiration_Height_Max': 1.0, 'Dispense_Rate': 0.25, 'Aliquot_Dispense_Rate': 0.25, 'Dilution_Dispense_Rate': 0.25, 'Mix_Dispense_Rate': 0.25, 'Final_Mix_Dispense_Rate': 0.25, 'Dispense_Height': 10.0, 'Aliquot_Dispense_Height': 10.0, 'Dilution_Dispense_Height': 10.0, 'Mix_Dispense_Height': 10.0, 'Mix_Dispense_Height_Min': 10.0, 'Mix_Dispense_Height_Max': 10.0, 'Mixing_Repetitions': 5, 'Mixing_Fraction': 0.9, 'Touch_Tip_Speed': 10, 'Touch_Tip_Radius': 0.8, 'Touch_Tip_V_Offset': -1.0, 'start_col': 10}
